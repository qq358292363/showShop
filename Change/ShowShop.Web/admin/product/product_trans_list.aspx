<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin_page.master" CodeBehind="product_trans_list.aspx.cs" Inherits="ShowShop.Web.admin.product.product_trans_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    { 
       ...
       if(confirm('确定要永久删除该信息吗?删除后将不能被恢复!'))
       {
        ...
        new Ajax.Request('product_trans_list.aspx', options);
    }
