<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin_page.master"  CodeBehind="deliver_list.aspx.cs" Inherits="ShowShop.Web.admin.product.deliver_list" %>
...
送货方式管理
    <asp:HyperLink ID="HyperLink2" runat="server"  CssClass="inputbutton" NavigateUrl="deliver_edite.aspx" Width="65px" Height="24px" onMouseOver="javascript:document.getElementById(this.id).className='inputbutton_a'" onMouseOut="javascript:document.getElementById(this.id).className='inputbutton'">添加信息</asp:HyperLink>
</asp:Content>
