<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="label_url_productclass.aspx.cs" Inherits="ShowShop.Web.admin.include.label_url_productclass" %>
...
function GetSubClass(ParentId){
	var url="label_url_productclass_ajax.aspx";
...
function ReturnValue()
{
	...
	parent.document.getElementById("txtFileName").value="productlist";
	parent.document.getElementById("txtFilePath").value="product/";
	parent.document.getElementById("txtParameter").value="q_cid="+cid;
	parent.document.getElementById("txtLabelContent").value=cnm;
