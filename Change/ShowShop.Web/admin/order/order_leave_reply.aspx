<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin_page.master" CodeBehind="order_leave_reply.aspx.cs" Inherits="ShowShop.Web.admin.order.order_leave_reply" %>
...
<table  class="form_table_input" border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtContent" TextMode="MultiLine" runat="server" 
                MaxLength="180" Height="83px" Enabled="false"></asp:TextBox>              
        </td>
        <td>
            <div class="msgNormal">该反馈的内容</div>  
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtReplyContent" TextMode="MultiLine" runat="server" 
                MaxLength="180" Height="83px" ></asp:TextBox>              
        </td>
        <td>
            <asp:Panel ID="txtReplyContentTip" runat="server"></asp:Panel>   
        </td>
    </tr>
