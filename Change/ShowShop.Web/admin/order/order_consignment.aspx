<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin_page.master" CodeBehind="order_consignment.aspx.cs" Inherits="ShowShop.Web.admin.order.order_consignment" %>
...
<table  class="form_table_input" border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td><asp:Literal ID="lblUserId" runat="server"></asp:Literal>
    ...
    <tr>
        <td class="form_table_input_info">送货方式：</td>
        <td>
            <asp:Literal ID="lblCourier" runat="server"></asp:Literal>  
        </td>
        <td>
           <div class="msgNormal">该订单指定的送货方式</div> 
       </td>
    </tr>
     
    <tr>
       <td class="form_table_input_info">发货日期：</td>
       <td>
          <asp:TextBox ID="txtConsignMentDate" runat="server" CssClass="date_input"></asp:TextBox>
       </td>
       <td>
           <div class="msgNormal">请选择发货的日期</div>      
       </td>
    </tr>
    
    <tr>
       <td class="form_table_input_info">快递公司：</td>
       <td>
           <asp:DropDownList ID="ddlExpressCompany" runat="server">
           </asp:DropDownList>
       </td>
       <td>
           <div class="msgNormal">请选择发货的快递公司</div>        
       </td>
    </tr>
    
    <tr>
       <td class="form_table_input_info">快递单号：</td>
       <td>
          <asp:TextBox ID="txtExpressOddNumbers" runat="server"></asp:TextBox>
          
       </td>
       <td>
           <asp:Panel ID="txtExpressOddNumbersTip" runat="server"></asp:Panel>   
       </td>
    </tr>
    
    <tr>
       <td class="form_table_input_info">经手人：</td>
       <td>
          <asp:TextBox ID="txtConsignMentPeople" MaxLength="8" runat="server"></asp:TextBox>
          
       </td>
       <td>
           <asp:Panel ID="txtConsignMentPeopleTip" runat="server"></asp:Panel>   
       </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ListItem Value="0">同时使用站内短信通知会员已经发货</asp:ListItem>
            <asp:ListItem Value="1">同时使用Email通知会员已经发货</asp:ListItem>
            <asp:ListItem Value="2">同时使用Email通知收货人已经发货</asp:ListItem>
            </asp:CheckBoxList>
        </td>
        <td>
