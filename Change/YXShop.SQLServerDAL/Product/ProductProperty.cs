...
{
    public class ProductProperty : IProductPropery
    {
        ...
        public int Add(ShowShop.Model.Product.productproperty model)
        {
            ...
            string sequel = "Insert into [yxs_productproperty](";
            sequel = sequel + "[cid], [filed], [datavalue], [type], [isrequire], [sort])";
            sequel = sequel + "Values(";
            sequel = sequel + "@cid, @filed,@datavalue,@type,@isrequire,@sort) Select scope_IDENTITY() ";
        ...
        public void Delete(int id)
        {
            ...
            sequel = "Delete From [yxs_productproperty]" + this.UpdateWhereSequel;
        ...
        {
            string sequel = "Update [yxs_productproperty] set  ";
            sequel = sequel + "[cid] =@cid ,[filed] =@filed ,[datavalue]=@datavalue ,[type] =@type ,[isrequire] =@isrequire ,[sort] =@sort";
        ...
        /// <returns></returns>
        public ShowShop.Model.Product.productproperty GetModel(System.Data.DataRow row)
        {
            ShowShop.Model.Product.productproperty model = new ShowShop.Model.Product.productproperty();
            if (row != null)
            {
        ...
        public ChangeHope.DataBase.DataByPage GetList()
        {
            ...
            dataPage.Sql = "[select] * [from] yxs_productproperty [where] 1=1 [order by] sort asc";
        ...
        protected string SelectSequel
        {
            get
            {
                if (selectSequel == string.Empty)
                    selectSequel = "SELECT [id], [cid], [filed], [datavalue], [type], [isrequire], [sort] FROM [yxs_productproperty] ";
                return selectSequel;
            }
            set
            {
        ...
        /// </summary>
        /// <remarks></remarks>
        public IDbDataParameter[] VauleParas(ShowShop.Model.Product.productproperty model)
        {
            ...
            paras[3] = new SqlParameter("@datavalue", SqlDbType.VarChar, 2000);
            paras[3].Value = model.Datavalue;
            paras[4] = new SqlParameter("@type", SqlDbType.Int, 4);
            paras[4].Value = model.Type;
            paras[5] = new SqlParameter("@isrequire", SqlDbType.Int, 4);
            paras[5].Value = model.IsRequire;
