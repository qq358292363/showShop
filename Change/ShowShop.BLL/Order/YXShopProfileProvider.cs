...
{
    public sealed class YXShopProfileProvider : ProfileProvider
    {

        // Get an instance of the Profile DAL using the ProfileDALFactory
        private static readonly IYXShopProfileProvider dal = ShowShop.DALFactory.DataAccess.CreateYXShopProfileProvider();
        ...
        private static string applicationName =ChangeHope.Common.ServerInfo.VersionInformation();
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "YX Shop Custom Profile Provider");
            }

            if (string.IsNullOrEmpty(name))
                name = "YXShopProfileProvider";
        ...
        public override SettingsPropertyValueCollection GetPropertyValues(SettingsContext context, SettingsPropertyCollection collection)
        {
            ...
            string username = HttpContext.Current.Session["MemberName"] == null ? (string)context["UserName"] : HttpContext.Current.Session["MemberName"].ToString();
            bool isAuthenticated = (bool)context["IsAuthenticated"];
            if (HttpContext.Current.Session["MemberName"] != null)
            {
                dal.UpdateProfile((string)context["UserName"], HttpContext.Current.Session["MemberName"].ToString());
            }
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection collection)
        {
            ...
            string username = HttpContext.Current.Session["MemberName"] == null ? (string)context["UserName"] : HttpContext.Current.Session["MemberName"].ToString();
            //dal.UpdateProfile((string)context["UserName"]);
