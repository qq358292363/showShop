<%@ Page Language="C#" MasterPageFile="~/admin/admin_page.master" AutoEventWireup="true" CodeBehind="deliver_list.aspx.cs" Inherits="ShowShop.Web.admin.systeminfo.deliver_list" Title="配送方式" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function SetInsuredCosts(id)
    {
        var insuredcostsid=$("txtInsuredCosts"+id).value;
        var num="^[0-9]*[1-9][0-9]*$";
        if(insuredcostsid.search(num)!=0)
        {
          return false;
        }
        var param = "Option=InsuredCosts&InsuredCostsID="+insuredcostsid+"&id=" + id;
        var options = 
        { method: 'post',parameters: param,onComplete:
             function(transport)
             {
...
名称：  <asp:TextBox ID="w_l_DistributionName"  runat="server"></asp:TextBox>&nbsp;
