<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin_page.master" CodeBehind="express_list.aspx.cs" Inherits="ShowShop.Web.admin.product.express_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    { 
       if(confirm('确定要永久删除该信息吗?删除后将不能被恢复!'))
       {
        ...
        new Ajax.Request('express_list.aspx', options);
    }
...
快递公司管理
    <asp:HyperLink ID="HyperLink2" runat="server"  CssClass="inputbutton" NavigateUrl="express_edite.aspx" Width="65px" Height="24px" onMouseOver="javascript:document.getElementById(this.id).className='inputbutton_a'" onMouseOut="javascript:document.getElementById(this.id).className='inputbutton'">添加信息</asp:HyperLink>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="pageinfo" runat="server">
</asp:Content>
<asp:Content ID="ContentSearch" ContentPlaceHolderID="pagesarch" runat="server">
名称：<asp:TextBox ID="w_l_name"  runat="server"></asp:TextBox>&nbsp;
