<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selarea.aspx.cs" Inherits="ShowShop.Web.admin.include.selarea" %>
...
function GetSubClassOk(OriginalRequest){
	...
	if (OriginalRequest.responseText!="" && OriginalRequest.responseText.indexOf("|||")>-1)
	{
		...
		if (ClassInfo[0]=="<div id=\"AreaList\">Succee"){
...
//    document.getElementById('ClsName').value = cname;
    ...
    {
         if(document.getElementById('ClsName').value.indexOf(cname)<=-1)
         {
