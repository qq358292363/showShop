<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sel_productclass.aspx.cs" Inherits="ShowShop.Web.admin.include.sel_productclass" %>
...
function GetSubClass(ParentId){
	var url="sel_productclass_ajax.aspx";
