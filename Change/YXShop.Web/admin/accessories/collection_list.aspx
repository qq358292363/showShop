<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/admin/admin_page.master" CodeBehind="collection_list.aspx.cs" Inherits="ShowShop.Web.admin.accessories.collection_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    { 
       ...
       if(confirm('确定要永久删除该信息吗?删除后将不能被恢复!'))
       {
        ...
        new Ajax.Request('collection_list.aspx', options);
    }
    </script>
    <script src="../scripts/images.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pagetitle" runat="server">收藏管理
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="pageinfo" runat="server">

</asp:Content>
<asp:Content ContentPlaceHolderID="pagesarch" ID="ContentSearch" runat="server"> 
用户账号：<asp:TextBox ID="w_l_collectionname"  runat="server"></asp:TextBox>
